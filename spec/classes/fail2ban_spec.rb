...
describe 'fail2ban', :type => :class do
  ...
  on_supported_os.each do |os, facts|
    context "on #{os}" do
      ...
      describe 'Test jails managed through file - source' do
      ...
      describe 'Test jails managed through file - custom template' do
        let(:params) { {:jails_config => 'file', :jails_template => 'fail2ban/spec.erb', :options => { 'opt_a' => 'value_a' } } }
        it { should contain_file('jail.local').with_content(/fqdn: foo.example.com/) }
      ...
      describe 'Test customizations - template' do
        ...
        it 'should generate a valid template' do
          should contain_file('fail2ban.local').with_content(/fqdn: foo.example.com/)
        end
      ...
      describe 'Test customizations - custom class' do
        ...
        it { should contain_file('fail2ban.local').with_content(/foo.example.com/) }
      end
      ...
      describe 'Test params lookup' do
        let(:facts) do
          facts.merge( { :monitor => true , :ipaddress => '10.42.42.42' } )
        end
      ...
      describe 'Test params lookup' do
        let(:facts) do
          facts.merge( { :fail2ban_monitor => true , :ipaddress => '10.42.42.42' } )
        end
      ...
      describe 'Test params lookup' do
        let(:facts) do
          facts.merge( { :monitor => false , :fail2ban_monitor => true , :ipaddress => '10.42.42.42' } )
        end
      ...
      describe 'Test params lookup' do
        let(:facts) do
          facts.merge( { :monitor => false , :ipaddress => '10.42.42.42' } )
        end
      ...
      if facts[:osfamily] == 'Debian'
        describe 'Test jails managed through file - template' do
